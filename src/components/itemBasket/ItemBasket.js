            ...
            <li className="list-group-item py-3">
                <div className="row g-3">
                    ...
                    <div className="col-4 col-md-3 col-lg-2">
                        ...
                        <Link to="/product">
                            <img className="mr-3 imgfruta" src={props.img} alt="Banana-Prata-Organica-600g-800g-Ved" />
                        </Link>
                    ...
                    <div className="col-12 offset-6 col-sm-6 offset-sm-6 col-md-4 offset-md-8 col-lg-3 offset-lg-0 col-xl-2 align-self-center mt-3">
                        ...
                        <div className="text-end mt-2 ">
                            <div className="input-group w-100 h-100 ">
                                <button onClick={incrementoCarrinho} className="btn btn-outline-dark  btn-green btn-sm" >
